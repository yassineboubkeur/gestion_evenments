...
export default function OrganizerLayout() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="flex">
        {/* Sidebar */}
        <aside className="w-64 bg-gradient-to-b from-blue-700 to-blue-800 text-white shadow-xl min-h-[calc(100vh-5rem)] sticky top-20">
          <div className="p-6">
            ...
            <p className="text-blue-200 text-sm mb-6">Manage your events and participants</p>
