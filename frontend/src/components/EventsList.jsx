  ...
  return (
    <div className="min-h-screen rounded-2xl  p-6">
      ...
      <div className="container mx-auto z-10">
        ...
        {/* Search Input */}
        <div className="mb-8">
  <h1 className="text-lg font-semibold mb-2 text-gray-800">Manage events</h1>
    ...
    <div className="flex flex-col md:flex-row gap-4">
      ...
      <div className="flex items-center space-x-4 bg-white/80 p-2 rounded-xl border border-white/30">
        ...
        <div className="flex items-center">
          ...
          />
          <label htmlFor="filter-approved" className="ml-2 text-sm font-medium text-gray-700">
            Approved
          </label>
        </div>
        <div className="flex items-center">
          ...
          />
          <label htmlFor="filter-pending" className="ml-2 text-sm font-medium text-gray-700">
            Pending
          </label>
        </div>
        <div className="flex items-center">
          ...
          />
          <label htmlFor="filter-rejected" className="ml-2 text-sm font-medium text-gray-700">
            Rejected
          </label>
        </div>
      </div>
                      ...
                      <div className="space-y-2 text-sm text-gray-600">
                        ...
                        <p>
                          ...
                          <span className={`font-medium ${
                            ...
                            event.status === 'rejected' ? 'text-red-600' : 'text-yellow-600'
                          }`}>
                            {event.status || 'pending'}
                          </span>
                        </p>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                  <div className="bg-gray-50 p-4 rounded-lg">
                    ...
                    <div className="space-y-2">
                      <p><span className="font-medium">Date:</span> {new Date(selectedEvent.date).toLocaleString()}</p>
                      <p><span className="font-medium">Location:</span> {selectedEvent.address}</p>
                      <p><span className="font-medium">Duration:</span> {selectedEvent.duration_minutes} minutes</p>
                      <p><span className="font-medium">Available Places:</span> {selectedEvent.available_places}</p>
                    </div>
                  </div>
                  
                  <div className="bg-gray-50 p-4 rounded-lg">
                    <h3 className="font-semibold text-gray-700 mb-2">Pricing & Category</h3>
                    <div className="space-y-2">
                      <p><span className="font-medium">Price:</span> {selectedEvent.price ? `$${parseFloat(selectedEvent.price).toFixed(2)}` : 'Free'}</p>
                      <p><span className="font-medium">Category:</span> {selectedEvent.category}</p>
                      <p>
                        <span className="font-medium">Status:</span>{" "}
                        <span className={`font-medium ${
                          selectedEvent.status === 'approved' ? 'text-green-600' : 
                          selectedEvent.status === 'rejected' ? 'text-red-600' : 'text-yellow-600'
                        }`}>
