    ...
    <div className="space-y-8">
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between">
        <div>
          ...
          <p className="text-lg text-gray-600 mt-1">Welcome back, <span className="text-blue-600 font-medium">{user?.name}</span>!</p>
        </div>
        <Link 
          to="/organizer/events/create"
          className="mt-4 md:mt-0 inline-flex items-center px-5 py-2.5 bg-blue-600 text-white font-medium rounded-lg hover:bg-blue-700 transition-colors shadow-md hover:shadow-lg"
        >
      ...
      <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
        <div className="flex justify-between items-center mb-6">
          <h3 className="text-xl font-semibold text-gray-800">Your Recent Events</h3>
          <Link 
            to="/organizer/events" 
        ...
        {loading ? (
          ...
          <div className="text-center py-8">
            ...
            <p className="mt-4 text-gray-500">No recent events found</p>
            <Link to="/organizer/events/create" className="mt-2 inline-block text-blue-600 hover:text-blue-800 font-medium">
...
function StatsCard({ title, count, link, icon, color, loading }) {
  ...
  return (
    <div className={`p-6 rounded-xl ${colorClasses[color]} border border-${color}-100`}>
