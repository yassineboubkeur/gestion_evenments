...
export default function loginUser({ onLoginSuccess, miniLogin }) {
  ...
  return (
    <div className={`min-h-screen flex items-center justify-center ${sharedString ? 'bg' + sharedString : 'bg0'}`}>
      <div className="w-full max-w-6xl mx-auto md:rounded-xl bg-white/60 shadow-xl overflow-hidden">
        <div className={`grid grid-cols-1 ${!miniLogin && "md:grid-cols-2"}`}>
          {/* Left Column - Branding/Info */}
          {!miniLogin && (
            <div className="backdrop-blur-md p-12 flex flex-col justify-center text-white">
              <div className="mb-8">
          ...
          <LoginForm onLoginSuccess={onLoginSuccess} miniLogin={miniLogin} />
        </div>
