    ...
    <div className="min-h-screen bg-gray-100">
      ...
      <div className="container mx-auto px-4 py-4">
        <div className="flex flex-col md:flex-row gap-8">
          ...
          <div className="w-full md:w-[350px] bg-white p-6 rounded-lg shadow-md">
            <div className="space-y-6">
              <div>
                <h2 className="text-lg font-semibold mb-3">Search Events</h2>
                <input
                  type="text"
                ...
                {isAuthenticated ? (
                  ...
                  <>
                    ...
                    <div className="mt-4">
                      ...
                      {showRegister && (
                        <div className="mb-4 p-4 border border-gray-200 rounded-lg">
                          <RegisterForm onRegisterSuccess={checkAuthStatus} />
                          <button 
                            onClick={closeForms}
                            className="mt-2 text-sm text-gray-500 hover:text-gray-700"
                          >
    ...
    {loading ? (
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {filteredEvents.map(event => (
          <div key={event.id} className="border rounded-lg overflow-hidden hover:shadow-lg transition-shadow flex flex-col">
