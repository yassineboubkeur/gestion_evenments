...
export default function HomePage() {
    ...
    const fetchEvents = async () => {
        try {
            ...
            setLoading(true);
            const response = await fetch("http://127.0.0.1:8000/api/allevents", { headers });
                        ...
                        <div className="p-6 rounded-2xl" style={glassStyle}>
                            <div className="space-y-6">
                                ...
                                <div>
                                    ...
                                    <select
                                        className="w-full p-3 bg-white/80 border border-white/30 rounded-xl text-md focus:ring-2 focus:ring-indigo-300 focus:border-indigo-300 transition-all appearance-none backdrop-blur-sm"
                                ...
                                <div className="pt-5 border-t border-white/20">
                                    {isAuthenticated ? (
                                        <div className="space-y-4">
                                            <div className="bg-white/30 p-4 rounded-xl" style={glassStyle}>
                                            ...
                                            <div className="grid grid-cols-2 gap-3">
                                                <button
                                                    ...
                                                    className="px-4 py-2 bg-gradient-to-r from-indigo-600 to-blue-600 text-white text-center rounded-xl hover:opacity-90 transition flex items-center justify-center shadow-md hover:shadow-lg"
                                                >
                                                ...
                                                <button
                                                    ...
                                                    className="px-4 py-2 bg-white/80 border border-red-500/30 text-red-500 text-center rounded-xl hover:bg-red-50 transition flex items-center justify-center shadow-md hover:shadow-lg backdrop-blur-sm"
                                                >
                                                    <svg className="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        ...
                                        <div className="grid grid-cols-2 gap-3">
                                            ...
                                            <Link 
                                                to="/register" 
                                                className="px-4 py-2 bg-gradient-to-r from-green-600 to-teal-500 text-white text-center rounded-xl hover:opacity-90 transition flex items-center justify-center shadow-md hover:shadow-lg"
                                            >
                                                <svg className="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                ...
                                                {currentEvents.map((event) => (
                                                    ...
                                                    >
                                                        ...
                                                        <div className="absolute top-3 left-3 flex items-center space-x-1">
                                                            ...
                                                            >
                                                                <svg
                                                                    className={`w-5 h-5 ${likedEvents.includes(event.id) ? 'text-red-500 fill-red-500' : 'text-gray-400'}`}
                                                                    fill="none"
                                                                    stroke="currentColor"
                                                                    viewBox="0 0 24 24"
                                                                >
